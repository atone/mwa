...
public class NABiLSTMAligner implements Aligner, Serializable {

	private static final long serialVersionUID = 1L;
	private NANN naNN;
	private BiLSTMSimAligner aligner;

	public NABiLSTMAligner(NN naNN, BiLSTMSimAligner aligner) {
		this.naNN = (NANN) naNN;
	...
	public Alignment align(SentenceVectors x, SentenceVectors y) {
		...
		Sequence seq = SentencePairBiRNNDataset.createSeqs(x, y, aligner.getFNN(), aligner.getBNN());

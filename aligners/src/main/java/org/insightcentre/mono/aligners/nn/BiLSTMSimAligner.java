...
/**
 * A Bi-LSTM based aligner between two sequences of words.
 * @author Kartik Asooja
 */
public class BiLSTMSimAligner implements Aligner, Serializable {

	private static final long serialVersionUID = 1L;
	private NN fnn;
	private NN bnn;

	public BiLSTMSimAligner(NN fnn, NN bnn){
		this.fnn = fnn;		
		this.bnn = bnn;
	}

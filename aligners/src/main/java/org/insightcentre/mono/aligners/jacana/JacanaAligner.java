...
public class JacanaAligner implements Aligner, Serializable {
	...
	private static String prevJacsPath = "jacData/jacAlignerMap.model";
	...
	public static void writePrevJacs(){
		...
		System.out.println("jacAlner written");
	}
	...
	public Alignment align(SentenceVectors x, SentenceVectors y) {
		...
		String tmpFilePath = "jacData/tmp.txt";
		String tmpOutFilePath = "jacData/tmp.json";
